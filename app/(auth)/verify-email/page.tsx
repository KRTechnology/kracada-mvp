        ...
        <div className="w-full md:w-[68%] flex flex-col items-center text-center">
          {verified ? (
            <>
              ...
              <h1 className="text-2xl font-bold mb-4 text-neutral-900 dark:text-neutral-200">
                Email Verified!
              </h1>
            ...
            <>
              ...
              <Button
                asChild
                className="bg-warm-200 hover:bg-warm-300 text-white dark:text-dark mb-4 w-full"
              >
