      ...
      <div className="w-full md:w-2/5 flex flex-col justify-center items-center px-8 py-16 bg-white">
        ...
        >
          <motion.div
            ...
            className="w-16 h-16 bg-peach-50 rounded-full flex items-center justify-center mb-4"
          >
            <svg
          ...
          <motion.p variants={itemVariants} className="text-neutral-500 mb-6">
          ...
          <motion.div
            variants={itemVariants}
            className="bg-warm-50 border border-warm-100 rounded-lg p-4 mb-8 text-left"
          >
