...
import { createVideoAction } from "@/app/(dashboard)/actions/video-actions";
...
type FormData = z.infer<typeof createVideoSchema>;
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-warm-200 via-warm-700 to-warm-800 rounded-2xl p-8 shadow-lg">
        <div className="relative z-10">
          ...
          <p className="text-warm-50 text-lg">
            Add a new video to the entertainment section
          </p>
        </div>
